...
SECRET_KEY = 'django-insecure-sdgrs=k)%t5g-1a5fyt0d)o0@(e48j&+i1y$cl@^x4g!fnb*eg'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'main/static'),  # путь к папке со статикой
]
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [os.environ.get("REDIS_URL")],  # Без SSL
        },
    },
}
